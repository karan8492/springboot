...
import one.to.many.repository.CourseRepository;
import one.to.many.repository.InstructorRepository;
...
public class CourseController {
    ...
    public List < Course > getCoursesByInstructor(@PathVariable(value = "courseId") Integer instructorId) {
        return courseRepository.findByInstructorId(instructorId);
    }
 
    @PostMapping("/instructors/{instructorId}/courses")
    public Course createCourse(@PathVariable(value = "instructorFirstname") Integer instructorId,
